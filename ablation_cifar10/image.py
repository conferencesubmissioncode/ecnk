...
X_train = cp.asarray(X_train).reshape(X_train.shape[0], X_train.shape[1], -1)
X_test = cp.asarray(X_test).reshape(X_test.shape[0], X_train.shape[1], -1)
X_train_flip = cp.asarray(X_train_flip).reshape(X_train_flip.shape[0], X_train_flip.shape[1], -1)
X_test_flip = cp.asarray(X_test_flip).reshape(X_test_flip.shape[0], X_test_flip.shape[1], -1)
