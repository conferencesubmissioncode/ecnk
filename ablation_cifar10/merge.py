...
parser.add_argument('-c', default = 32, type = int, help = 'Crop pixels')
...
parser.add_argument('-nvaltrain', default = 10000, type = int, help = "Number of training data in cross validation")
