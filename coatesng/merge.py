...
parser.add_argument('-c', default = 20, type = int, help = 'Crop pixels')
parser.add_argument('-c_delta', default = 4, type = int, help = 'Crop pixels interval')
parser.add_argument('-c_min', default = 4, type = int, help = 'Min crop pixels')
parser.add_argument('-ker_num', default = 2, type = int, help = '2 if Tangent + Convariance Kernel')
parser.add_argument('-bsize', default = 100, type = int, help = 'Block size')
...
y_train = pickle.load(open("data/cifar10_train_label")).astype(int).reshape(-1)
y_test = pickle.load(open("data/cifar10_test_label")).astype(int).reshape(-1)
N_class = 10
